...
export function KanbanColumn({ column, tasks, onAdd }: KanbanColumnProps) {
  ...
  return (
    <section
      ...
      className={cn(
        ...
        isOver ? 'bg-surface-card' : 'bg-surface-soft',
      )}
    >
      ...
      {isOver && (
        <div className="border-checkbox-border h-[104px] rounded-lg border border-dashed" />
      )}
